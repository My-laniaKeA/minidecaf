...
class VarDecl : public Statement {
  public:
	...
	VarDecl(std::string n, Type *t, DimList *d, Location *l);
	VarDecl(std::string n, Type *t, DimList *d, DimList *arr_init, Location *l);
...
class AssignExpr : public Expr {
  public:
	...
	AssignExpr(LvalueExpr *left, Expr *e0, Location *l);
	AssignExpr(std::string lv_name, Expr *e0, Location *l);
	AssignExpr(std::string lv_name, ExprList *idx_list, Expr *e0, Location *l);
...
/* Node representing a index expression.
 *
 * SERIALIZED FORM:
 *   (IDENTIFIER ExprList)
 */
class IndexExpr : public Expr {
  public:
    IndexExpr(std::string base_name, ExprList* idx_list, Location *l);
  ...
  public:
    ...
    ExprList *idx_list;	// list of index at each dimension
	DimList *dim;		// list of length at each dimension
...
class CallExpr : public Expr {
  public:
    CallExpr(std::string func_name, ExprList* exprs, Location *l);
...
class VarRef : public Lvalue {
  public:
	...
	VarRef(std::string var_name, ExprList *idx_list, Location *l);
...
class LvalueExpr : public Expr {
  public:
	...
	LvalueExpr(std::string lv_name, Location *l);
	LvalueExpr(std::string lv_name, ExprList *idx_list, Location *l);
