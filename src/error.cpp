...
BadGlobalInitError::BadGlobalInitError(std::string _name) { name = _name;}
void BadGlobalInitError::printTo(std::ostream &os) {
    os << "global variable " << name << " must be initialized with const";
}
