 ...
 * 	 decl 	 - is this Func symbol a forward declaration or full
 */
Function::Function(std::string n, Type *resType, Location *l, bool decl) {
...
bool Function::isDecl(void) {return is_decl; }
